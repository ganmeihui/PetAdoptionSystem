...
if (isset($_POST["submit"])) {
  ...
  $sql = "UPDATE `user` SET `username`='$name',`gender`='$gender',`DOB`='$dob',`mobile`='$mobile',`email`='$email' WHERE user_id = $id";
    ...
    <div class="container d-flex justify-content-center">
      <form action="" method="post" style="width:50vw; min-width:300px;">
        ...
        <div class="mb-3">
          ...
          <input type="date" class="form-control" name="DOB" value="<?php echo $row['DOB'] ?>" readonly>
        </div>
